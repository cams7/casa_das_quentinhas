...
ALTER SEQUENCE cidade_id_seq OWNED BY cidade.id_cidade;
------------------------------------------------- Acesso --------------------------------------------------
CREATE TABLE acesso (
...
ALTER SEQUENCE empresa_id_seq OWNED BY empresa.id_empresa;
------------------------------------------------- Funcionário --------------------------------------------------
...
COMMENT ON TABLE cliente_pedido IS 'Relação entre o pedido e o cliente';