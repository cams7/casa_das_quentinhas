 ...
 * @version $Id: CrosstabApp.java,v 1.9 2006/06/30 16:02:41 lucianc Exp $
 */
public class CrosstabApp {
	...
	private static final String[] reportNames = { "OrdersReport", "ProductsReport", "ShipmentsReport",
			"LateOrdersReport" };
		...
		try {
			if (TASK_FILL.equals(taskName)) {
				for (int i = 0; i < reportNames.length; i++) {
					...
					System.err.println(
							"Report : " + reportNames[i] + ". Filling time : " + (System.currentTimeMillis() - start));
				}
				System.exit(0);
				...
				for (int i = 0; i < reportNames.length; i++) {
					...
					System.err.println(
							"Report : " + reportNames[i] + ". Printing time : " + (System.currentTimeMillis() - start));
				}
				System.exit(0);
				...
				for (int i = 0; i < reportNames.length; i++) {
					...
					System.err.println("Report : " + reportNames[i] + ". PDF creation time : "
				...
				for (int i = 0; i < reportNames.length; i++) {
					...
					System.err.println("Report : " + reportNames[i] + ". XML creation time : "
							+ (System.currentTimeMillis() - start));
				}
				System.exit(0);
				...
				for (int i = 0; i < reportNames.length; i++) {
					...
					System.err.println("Report : " + reportNames[i] + ". HTML creation time : "
							+ (System.currentTimeMillis() - start));
				}
				System.exit(0);
				...
				for (int i = 0; i < reportNames.length; i++) {
					...
					System.err.println("Report : " + reportNames[i] + ". RTF creation time : "
							+ (System.currentTimeMillis() - start));
				}
				System.exit(0);
				...
				for (int i = 0; i < reportNames.length; i++) {
					...
					System.err.println("Report : " + reportNames[i] + ". XLS creation time : "
							+ (System.currentTimeMillis() - start));
				}
				...
				for (int i = 0; i < reportNames.length; i++) {
					...
					System.err.println("Report : " + reportNames[i] + ". CSV creation time : "
							+ (System.currentTimeMillis() - start));
				}
				System.exit(0);
				...
				for (int i = 0; i < reportNames.length; i++) {
					...
					System.err.println("Report : " + reportNames[i] + ". PDF running time : "
							+ (System.currentTimeMillis() - start));
				}
				System.exit(0);
			} else {
